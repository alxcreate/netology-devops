...
1. Из разобранных ранее инструментов образ можно создать с помощью Packer.
2. [Конфигурация Terraform](https://github.com/alxcreate/netology-devops/tree/main/Homeworks/02-virt-homeworks/07-terraform-02-syntax/terraform)
